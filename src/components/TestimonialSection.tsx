...
export const TestimonialSection: React.FC = () => {
  return (
    <section className="py-16 lg:py-24 bg-slate-950 text-white border-b border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-12">
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-slate-900 text-white max-w-2xl mx-auto shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6 border border-slate-800">
          <div className="flex items-center gap-4 text-center sm:text-left">
            <div className="w-16 h-16 rounded-2xl bg-blue-600 text-white font-heading font-black text-2xl flex items-center justify-center shrink-0 shadow-xs">
              5.0
            </div>
            <div>
          ...
          <a
            ...
            className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow-xs transition-all shrink-0 flex items-center gap-2 cursor-pointer"
          >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {TESTIMONIALS.map((item) => (
            <div
              key={item.id}
              className="bg-slate-900 rounded-2xl p-6 sm:p-8 border border-slate-800 hover:border-slate-700 transition-all duration-200 flex flex-col justify-between space-y-6"
            >
              ...
              <div className="pt-4 border-t border-slate-800 flex items-center justify-between text-xs">
                <div>
                  ...
                  <p className="text-slate-400">{item.role} • {item.location}</p>
                </div>
        ...
        <div className="text-center text-xs text-slate-400 max-w-xl mx-auto space-y-2 pt-4">
          ...
          <p>
            We welcome your authentic feedback! <a href={BUSINESS_INFO.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline font-bold">Leave a review on Google Maps</a> to help fellow residents in Bidar choose trusted insurance protection.
          </p>
        </div>
